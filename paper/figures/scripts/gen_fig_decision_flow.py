...
def box(ax, xy, w, h, text, facecolor="#EAF2F8", edgecolor="#1B4F72", fontsize=9.2, weight="normal"):
    x, y = xy
...
def main():
    ...
    b_enum = box(ax, (0.3, 5.95), 4.9, 1.15,
                  ...
                  facecolor="#EBF5FB", edgecolor="#1F618D", fontsize=8.8)
    ...
    b_switch = box(ax, (0.3, 3.35), 6.35, 2.15,
                    ...
                    facecolor="#EAFAF1", edgecolor="#1E8449", fontsize=8.8)

    b_dwell = box(ax, (6.95, 3.35), 2.15, 1.0,
                   "Dwell / hysteresis\n($E_0$, tie-break\n$\\varepsilon_{in}{<}\\varepsilon_{out}$)",
                   facecolor="#EAFAF1", edgecolor="#1E8449", fontsize=8.2)
    b_rho = box(ax, (6.95, 4.5), 2.15, 1.0,
    ...
    b_safety = box(ax, (0.3, 1.15), 6.35, 1.75,
                    ...
                    facecolor="#FDEDEC", edgecolor="#943126", fontsize=9.0)
    ...
    ax.text(3.7, 3.05, "commit $c^*\\!\\leftarrow c'$, $e^{rev}\\!\\leftarrow 0$, $\\rho\\!\\leftarrow 0$",
             ha="center", va="center", fontsize=7.6, style="italic", color="#1E8449")
    ...
    b_traj = box(ax, (0.3, 0.15), 6.35, 0.75,
                  ...
                  facecolor="#F4ECF7", edgecolor="#6C3483", fontsize=9.2)
    ...
    ax.text(-0.12, 3.2, "safety\npriority\n(overrides)", rotation=90, ha="center", va="center",
             fontsize=7.6, color="#943126", weight="bold")
